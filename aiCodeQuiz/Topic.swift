...
struct Topic:Identifiable, Hashable {
    ...
    static let all:[Topic] = [
        ...
        .init(name: "Types", prompt: "primitive types, and reference types", description: "learn primitive and reference types.", colors: [.purple,.teal], image: Image(systemName: "apple.terminal")),
        .init(name: "Methods", prompt: "methods including parameters and return types", description: "learn  return types and parameters", colors: [.orange,.yellow], image: Image(systemName: "return")),
        .init(name: "recursion", prompt: "recursion and recrusive functions", description: "learn about recursive methods.", colors: [.green,.darkGreen], image: Image(systemName: "square.stack"))
